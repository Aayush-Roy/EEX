...
const teamMembers = [
  { id: 'michael', name: 'MICHAEL', role: 'Narrative & Creative Direction', image: '/profiles/michael.png' },
  { id: 'sanjay', name: 'SANJAY', role: 'Visual Development', image: '/profiles/sanjay.png' },
  { id: 'abhishek', name: 'ABHISHEK', role: 'Cinematography & Story Design', image: '/profiles/abhishek.png' },
  { id: 'charu', name: 'CHARU', role: 'Technical Direction', image: '/profiles/charu.png' },
  { id: 'nisha', name: 'NISHA', role: 'Cinematography & Story Design', image: '/profiles/nisha.png' },
  { id: 'shivang', name: 'SHIVANG', role: 'Production & Photography', image: '/profiles/shivang.png' },
];
